# -*- coding: utf-8 -*-
"""BPR training and Top-K evaluation procedures for LightGCN."""
    ...
    with torch.no_grad():
        ...
        for batch_users in utils.minibatch(users, batch_size=u_batch_size):
            ...
            for range_i, (uid_raw, items) in enumerate(zip(batch_users, allPos)):
                # Mask known positives before Top-K retrieval. For validation-selected
                # test runs this also includes the held-out validation interactions.
